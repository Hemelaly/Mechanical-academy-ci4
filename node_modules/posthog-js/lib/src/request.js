...
var buildRequestURL = function (url, method, compression, timestampMode) {
    ...
    return (0, exports.extendURLParams)(compression === types_1.Compression.GZipJS ? removeURLParam(requestURL, 'compression') : requestURL, __assign(__assign(__assign({}, (timestampParam ? (_a = {}, _a[timestampParam] = Date.now().toString(), _a) : {})), (versionlessEndpoint ? {} : { ver: config_1.default.JS_SDK_VERSION })), (compression === types_1.Compression.GZipJS ? {} : { compression: compression })));
};
...
var request = function (_options) {
    ...
    if (options.timestampMode === 'body' && options.method === 'POST' && options.data && !(0, core_1.isArray)(options.data)) {
