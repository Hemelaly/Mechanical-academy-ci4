...
import { Properties, RageclickConfig, DeadClicksAutoCaptureConfig, SupportedWebVitalsMetrics, CaptureResult, SurveyRenderReason, ToolbarParams, FeatureFlagsCallback, JsonType, FeatureFlagDetail, FeatureFlagResult, FeatureFlagOptions, RemoteConfigFeatureFlagCallback, IsFeatureEnabledOptions, OverrideFeatureFlagsOptions, EarlyAccessFeatureCallback, EarlyAccessFeatureStage, CaptureLogOptions, Logger, CaptureMetricOptions, PostHog as PostHog$1, PostHogConfig as PostHogConfig$1, PerformanceCaptureConfig, SessionRecordingCanvasOptions, InitiatorType, CapturedNetworkRequest, SessionRecordingOptions, EventName, BeforeSendFn, KnownEventName } from '@posthog/types';
