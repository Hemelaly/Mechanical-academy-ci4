...
--
-- Host: localhost:3306
-- Generation Time: Oct 13, 2025 at 11:42 AM
...
(15, 15, 'email_password', NULL, 'hemelaly02@gmail.com', '$2y$12$SctU77Nw567mZJZt6i/0NuXrTLGtcUA3nzeozXdvpUxE.VBQ5sVcG', NULL, NULL, 0, '2025-10-13 08:09:06', '2025-10-10 16:42:11', '2025-10-13 08:09:06'),
...
(14, 'c366a5a22174b088a720afa4', '7ecc366116a8ab3c81b5247cbc19581bc4ee6ab2fbeaa94f76af6c830f01bf7c', 1, '2025-11-12 10:40:56', '2025-10-13 10:40:56', '2025-10-13 10:40:56'),
(15, '5888d87a5a0290616a4bb55f', 'f29124a0a7b94dad3cc38f1f6aaad2aeffee9b29e861be6854008c9e4fd44f0a', 16, '2025-11-12 10:41:51', '2025-10-13 10:41:51', '2025-10-13 10:41:51');
...
CREATE TABLE `enrollments` (
  ...
  `progress_enrollment` tinyint DEFAULT '0',
...
INSERT INTO `enrollments` (`id_enrollment`, `id_student_enrollment`, `id_course_enrollment`, `status_enrollment`, `progress_enrollment`, `enrolled_at_enrollment`, `created_at`, `updated_at`) VALUES
(12, 15, 18, 'Ativa', 0, '2025-10-10', '2025-10-10 16:42:16', '2025-10-10 16:42:16'),
(13, 16, 18, 'Ativa', 0, '2025-10-13', '2025-10-13 10:41:18', '2025-10-13 10:41:18');
...
ALTER TABLE `lessons`
  ...
  ADD KEY `id_module_lesson` (`id_module_lesson`);
...
ALTER TABLE `modules`
  ...
  ADD KEY `id_course_module` (`id_course_module`);
