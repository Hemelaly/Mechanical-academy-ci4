...
<div class="container-fluid">
    <div class="mb-5">
        ...
        <div class="p-4 bg-modern-dark rounded-lower">
            ...
            <!-- Form -->
            <form id="courseForm" action="<?= base_url('instructor/dashboard/meus_cursos/' . $course->id_course . '/editar') ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" id="title_course" name="title_course"
                                                placeholder="Ex: Desenvolvimento Web Completo" value="<?= $course->title_course ?? '' ?>" required />
                                        </div>
                                        <div class="mb-4">
                                            <label for="courseSubtitle" class="form-label fw-semibold">
                                                <i class="fas fa-align-left me-2 text-primary"></i>Subtítulo do Curso *
                                            </label>
                                            <input type="text" class="form-control" id="courseSubtitle" name="subtitle_course" value="<?= $course->subtitle_course ?? '' ?>" placeholder="Ex: Do zero ao avançado com HTML, CSS e JavaScript" required />
                                        </div>
                                        <div class="mb-4">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-4">
                                            ...
                                            <input type="file" class="form-control" id="courseImage" name="image_course" accept="image/*" value="<?= $course->image_course ?? '' ?>" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3" id="price-settings" style="display: none">
                                    ...
                                    <input type="number" class="form-control" id="coursePrice" name="price_course" min="0" step="0.01" value="<?= $course->price_course ?? '' ?>" />
                                </div>
                            </div>
                        </div>
                    </div>
