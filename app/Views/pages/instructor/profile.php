                ...
                <div class="flex flex-col md:flex-row items-center gap-6">
                    ...
                    <div class="flex items-center gap-6">
                        <div class="text-center">
                            <div class="text-2xl font-bold text-slate-800 dark:text-white"><?= esc((int) ($courseCount ?? 0)) ?></div>
                            <div class="text-slate-500 dark:text-slate-400 text-sm">Cursos</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-slate-800 dark:text-white"><?= esc((int) ($avgProgress ?? 0)) ?>%</div>
...
<div id="profileModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50 p-4">
    <div class="bg-white dark:bg-slate-800 rounded-3xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <!-- Modal Content -->
        <div class="p-6">
            <form action="<?= site_url('/instructor/dashboard/perfil') ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
