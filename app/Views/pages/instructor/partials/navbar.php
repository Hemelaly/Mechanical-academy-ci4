...
<header
    ...
    <div class="flex shrink-0 items-center gap-1.5 sm:gap-2">
        ...
        <div class="relative">
            <button class="dropdown-toggle relative inline-flex h-9 w-9 cursor-pointer items-center justify-center overflow-visible rounded-md border border-slate-200 bg-white text-slate-700 hover:bg-slate-50 dark:border-white/10 dark:bg-[#11151c] dark:text-slate-400 dark:hover:bg-white/5" aria-label="Notificações">
                <i class="bi bi-bell"></i>
                <span id="instructor-notifications-dot" class="pointer-events-none absolute -right-0.5 -top-0.5 hidden h-2.5 w-2.5">
