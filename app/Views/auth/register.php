        ...
        <div class="col-12 col-md-5 pt-5">
            <div class="card-body">
                ...
                <form action="<?= url_to('register') ?>" method="post">
                    ...
                    <!-- Role -->
                    <div class="form-floating mb-4">
                        <select class="form-select" id="floatingRoleInput" name="role" required>
                            <?php
                            $roleQuery = service('request')->getGet('role');
                            $selectedRole = old('role') ?? ($roleQuery ?: 'student');
                            ?>
                            <option value="student" <?= $selectedRole === 'student' ? 'selected' : '' ?>>Aluno</option>
                            <option value="instructor" <?= $selectedRole === 'instructor' ? 'selected' : '' ?>>Instrutor</option>
                            <option value="admin" <?= $selectedRole === 'admin' ? 'selected' : '' ?>>Administrador</option>
                        </select>
                        <label for="floatingRoleInput">Tipo de usuario</label>
                    </div>
